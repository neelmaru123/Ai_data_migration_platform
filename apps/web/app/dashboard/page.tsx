                      ...
                      <div className="flex items-start justify-between gap-3 border-b border-zinc-900 pb-3">
                        <div>
                          <div className="flex items-center gap-2 mb-1">
                            <span
                              className={`w-2.5 h-2.5 rounded-none ${isOnline
                            ...
                            />
                            <span
                              className={`text-[9px] font-bold tracking-widest px-2 py-0.5 uppercase border ${isOnline
                            ...
                            ag.data_sources.map((ds) => (
                              ...
                              >
                                ...
                                <div className="flex items-center gap-1.5">
                                  <span
                                    className={`px-1.5 py-0.2 text-[9px] font-bold uppercase rounded-none border ${ds.role === 'target'
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-1">
                ...
                <div className="flex items-center gap-1 flex-wrap bg-black/60 p-1 border border-zinc-900 shrink-0">
                  <button
                    ...
                    className={`inline-flex items-center gap-1.5 px-3 py-1 text-[11px] font-mono font-semibold uppercase transition-colors ${activeTab === 'powershell'
                  ...
                  <button
                    ...
                    className={`inline-flex items-center gap-1.5 px-3 py-1 text-[11px] font-mono font-semibold uppercase transition-colors ${activeTab === 'bash'
                        ? 'bg-sky-400/20 text-sky-400 border border-sky-400/40 shadow-sm'
                        : 'text-zinc-400 hover:text-white border border-transparent'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`inline-flex items-center gap-1.5 px-3 py-1 text-[11px] font-mono font-semibold uppercase transition-colors ${activeTab === 'oneline'
                        ? 'bg-sky-400/20 text-sky-400 border border-sky-400/40 shadow-sm'
                        : 'text-zinc-400 hover:text-white border border-transparent'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`inline-flex items-center gap-1.5 px-3 py-1 text-[11px] font-mono font-semibold uppercase transition-colors ${activeTab === 'env'
                        ? 'bg-sky-400/20 text-sky-400 border border-sky-400/40 shadow-sm'
                        : 'text-zinc-400 hover:text-white border border-transparent'
                      }`}
                  >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {selectedAgentForCmd.data_sources.map((ds: any) => {
                          ...
                          return (
                            <div
                              key={ds.identifier}
                              className={`p-3 border bg-black/90 space-y-2 ${isSource ? 'border-sky-500/20' : 'border-emerald-500/20'
                                }`}
                            >
                              <div className="flex items-center justify-between pb-1 border-b border-zinc-900">
                                <div className="flex items-center gap-1.5 min-w-0">
                                  <Database
                                    className={`w-3.5 h-3.5 shrink-0 ${isSource ? 'text-sky-400' : 'text-emerald-400'
                                      }`}
                                  />
                                ...
                                <span
                                  className={`text-[9px] font-bold px-1.5 py-0.2 uppercase border ${isSource
                                      ? 'bg-sky-400/10 text-sky-400 border-sky-400/30'
