...
export default function Hero({ sceneUrl }: HeroProps) {
  return (
    <section className="relative w-full bg-black overflow-hidden">
      {/* 3D Spline Scene (Fullscreen 100vh with built-in design, non-interactive) */}
      <div className="relative w-full h-screen">
        ...
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-20 flex flex-col items-center gap-2 pointer-events-auto">
          <a
            ...
            className="text-slate-400 hover:text-indigo-400 transition-colors animate-bounce p-2 flex flex-col items-center gap-1 text-xs font-mono tracking-widest uppercase"
          >
